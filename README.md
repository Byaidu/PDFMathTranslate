...
> Note:
> 
> You can choose to install optional dependencies based on the services you need.
> Currently, optional dependencies include `azure`, `argos` and `tencent`.
> 
> If you need to install one of the options, such as `argos`, use `pip install "pdf2zh[argos]"` to install it.
> 
