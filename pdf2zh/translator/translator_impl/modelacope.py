...
class ModelScopeTranslator(BaseTranslator):
    ...
    def __init__(
        ...
        self.client = openai.OpenAI(
            base_url=settings.translate_engine_settings.modelscope_base_url,
            api_key=settings.translate_engine_settings.modelscope_api_key,
        )
        self.add_cache_impact_parameters("temperature", self.options["temperature"])
        self.model = settings.translate_engine_settings.modelscope_model
