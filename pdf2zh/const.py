...
DEFAULT_CONFIG_FILE = DEFAULT_CONFIG_DIR / f"config.v{__major_version__}.toml"
WRITE_TEMP_CONFIG_FILE = DEFAULT_CONFIG_DIR / f"config.v{__major_version__}.temp.toml"
